...
class SentimentIntentAnalyzer:
    def __init__(self):
        ...
        if not api_key:
            ...
            # We don't raise here to allow importing, but analyze will fail if called without key.
            # actually original raised, so I'll keep it.
    ...
    def analyze(self, message: str) -> dict:
        ...
        if not self.client:
             ...
             return {"intent": "general", "sentiment_score": 5, "language": "en"}
